...
export const FEDERAL_INDEXATION_RULES = [
  ...
  { path: "credits.ageAmount.amount", indexed: true, class: "indexed" },
  { path: "credits.ageAmount.phaseOutStart", indexed: true, class: "indexed" },
  { path: "oasRecovery.threshold", indexed: true, class: "indexed" },
  ...
  { path: "credits.ageAmount.phaseOutRate", indexed: false, class: "fixed" },
  { path: "credits.ageAmount.minimumAge", indexed: false, class: "fixed" },
  { path: "credits.pensionIncomeAmount.amount", indexed: false, class: "fixed" },
  { path: "oasRecovery.rate", indexed: false, class: "fixed" },
